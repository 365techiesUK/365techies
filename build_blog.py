...
POSTS = [
 ...
 dict(slug="refurbished-vs-new-laptop", cat="Home Users",
   ...
   faqs=[
     ...
     ("Is the warranty as good as buying new?","It can be better. Ours include any remaining Dell warranty where applicable plus our own 5-year guarantee, and you keep your Consumer Rights Act protection as a UK buyer."),
 ...
 dict(slug="is-it-safe-to-buy-a-refurbished-laptop", cat="Home Users",
   ...
   faqs=[
     ...
     ("What if it goes wrong after I buy it?","From us you are covered by any remaining Dell warranty where applicable, our own 5-year guarantee and a full repair service &mdash; and as a UK buyer, by the Consumer Rights Act. You always have someone local to call."),
