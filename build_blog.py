...
POSTS = [
 ...
 dict(slug="how-monthly-it-support-saves-time", cat="Monthly Support",
   title="How Monthly IT Support Saves Businesses Time",
 ...
 dict(slug="why-home-users-need-regular-maintenance", cat="Monthly Support",
   title="Why Home Computers Need Regular Maintenance",
 ...
 dict(slug="what-to-do-when-an-employee-leaves", cat="Business IT",
   ...
   related=[("Business IT Support","/business-it-support-subscriptions/"),("Microsoft 365 Support","/microsoft-365-support/"),("Cybersecurity","/cybersecurity-support/"),("New Employee Laptop Setup","/new-employee-laptop-setup/")]),
