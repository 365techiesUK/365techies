...
- Free Windows app: "365 PC Manager" (https://365techies.co.uk/free-pc-health-check/) — a free PC health check for Windows 10 & 11 made by 365 Techies: health score, drive (SMART) health, one-tap boost, live performance graphs, backup & startup checks and a plain-English report. Free forever, no sign-up; reads the PC and changes nothing without a tap; distinct from Microsoft's "PC Health Check" (Windows 11 eligibility tool) and Microsoft's "PC Manager" utility
