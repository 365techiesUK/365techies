...
- Notable business clients (past & present): IT support partner for Mercedes-Benz Pentagon across the south coast (1998-2008); supported David F Green & Associates and then the Poole financial advisers PFM Associates from 1997 to 2016, through the 2003 acquisition, with IT migration, office relocation and IT sales & support; and since 2016 support Emblem Sports Cars (Poole), the South Coast's independent Ferrari, Maserati & Lamborghini specialists, including their car diagnostic systems; and provide IT sales, servicing and support to Vivid Websites (a Bournemouth web design and development agency whose sites serve local colleges, attractions, businesses and events) since 2010
