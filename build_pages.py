...
# 14 Sep 2026 (performance audit item 3): the spec checker and benchmark scripts left the HTML (22 + 29 KB inline,
# parser-blocking on every visit) for deferred, cached files. Same content-hash cache-bust as search.js.
def _jsv(name):
    try:
...
_VOLATILE = [
    ...
    (_cdre.compile(r' data-cv\b'), ''),
    # 14 Sep 2026: the fix flow's own "Last reviewed <date>" line is a second copy of the page date. It was not
...
HEADER = '''  <header class="site-header">
    <div class="status-ticker">
      <div class="status-ticker__track" aria-hidden="true">
        <span><b class="tk-live" data-tk-live hidden><i class="tk-dot" aria-hidden="true"></i>LIVE&ensp;<span data-tk-live-text></span>&ensp;<em class="tk-sep">//</em>&ensp;</b><a class="tk-alert" href="/ive-been-scammed-what-to-do/" tabindex="-1"><i class="tk-dot tk-dot--red" aria-hidden="true"></i>BEEN SCAMMED? WHAT TO DO NOW &rarr;</a>&ensp;<em class="tk-sep">//</em>&ensp;<a href="tel:+441202775566" tabindex="-1">CALL 01202 775566</a>&ensp;<em class="tk-sep">//</em>&ensp;MON&ndash;FRI 9&ndash;5 &middot; SAME-DAY, USUALLY MINUTES REMOTELY&ensp;<em class="tk-sep">//</em>&ensp;<a href="/pricing/" tabindex="-1">IT SUPPORT PLANS FROM &pound;18.25/MO</a>&ensp;<em class="tk-sep">//</em>&ensp;FAMILY BUSINESS SINCE 1995 &middot; VERIFIED MICROSOFT PARTNER &middot; BOURNEMOUTH &middot; POOLE &middot; DORSET&ensp;<em class="tk-sep">//</em>&ensp;<a href="/is-it-down/" tabindex="-1">IS IT DOWN, OR JUST YOU? CHECK LIVE</a>&ensp;<em class="tk-sep">//</em>&ensp;<a href="/sos/" tabindex="-1">SOS REMOTE SUPPORT &mdash; WE&rsquo;LL DO IT TOGETHER</a>&ensp;<em class="tk-sep">//</em>&ensp;<a href="/mobile-signal-check/" tabindex="-1"><b class="tk-new">NEW</b>&thinsp;BOURNEMOUTH MOBILE SIGNAL MAP</a>&ensp;<em class="tk-sep">//</em>&ensp;</span>
        <span><b class="tk-live" data-tk-live hidden><i class="tk-dot" aria-hidden="true"></i>LIVE&ensp;<span data-tk-live-text></span>&ensp;<em class="tk-sep">//</em>&ensp;</b><a class="tk-alert" href="/ive-been-scammed-what-to-do/" tabindex="-1"><i class="tk-dot tk-dot--red" aria-hidden="true"></i>BEEN SCAMMED? WHAT TO DO NOW &rarr;</a>&ensp;<em class="tk-sep">//</em>&ensp;<a href="tel:+441202775566" tabindex="-1">CALL 01202 775566</a>&ensp;<em class="tk-sep">//</em>&ensp;MON&ndash;FRI 9&ndash;5 &middot; SAME-DAY, USUALLY MINUTES REMOTELY&ensp;<em class="tk-sep">//</em>&ensp;<a href="/pricing/" tabindex="-1">IT SUPPORT PLANS FROM &pound;18.25/MO</a>&ensp;<em class="tk-sep">//</em>&ensp;FAMILY BUSINESS SINCE 1995 &middot; VERIFIED MICROSOFT PARTNER &middot; BOURNEMOUTH &middot; POOLE &middot; DORSET&ensp;<em class="tk-sep">//</em>&ensp;<a href="/is-it-down/" tabindex="-1">IS IT DOWN, OR JUST YOU? CHECK LIVE</a>&ensp;<em class="tk-sep">//</em>&ensp;<a href="/sos/" tabindex="-1">SOS REMOTE SUPPORT &mdash; WE&rsquo;LL DO IT TOGETHER</a>&ensp;<em class="tk-sep">//</em>&ensp;<a href="/mobile-signal-check/" tabindex="-1"><b class="tk-new">NEW</b>&thinsp;BOURNEMOUTH MOBILE SIGNAL MAP</a>&ensp;<em class="tk-sep">//</em>&ensp;</span>
      </div>
    ...
    <div class="header-bar">
      ...
      <div class="header-actions">
        ...
        <a href="/portal/" class="nav-signin" aria-label="Sign in to your 365 customer portal">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><span class="nav-signin__t">Sign in</span>
        </a>
  ...
  <script>
  /* Header sign-in state. Telling a signed-in customer to "Sign in" reads as broken -
     and telling a first-time visitor only "Sign in" reads as members-only, hiding the
     free membership from the people we most want to join. So: signed OUT invites
     joining (in the drawer, where there is room); signed IN says where the button
     actually goes. Inline and tiny so it settles before anyone reads the header.
     Session shapes match the portal: customer = localStorage p365 with a wtoken;
     staff/view-as = sessionStorage p365s. Never render the person's name here - on a
     shared computer that would announce who last used it. */
  (function () {
    var cust = false, staff = false;
    try {
      var a = JSON.parse(localStorage.getItem('p365') || '{}') || {};
      var b = JSON.parse(sessionStorage.getItem('p365s') || '{}') || {};
      staff = !!(a.staff || a.stoken || b.staff || b.stoken);
      cust = !staff && !!a.wtoken;
    } catch (e) { return; }
    if (!cust && !staff) return;
    var label = staff ? 'Staff area' : 'Your portal';
    var aria = staff ? 'Open the 365 staff area' : 'Go to your 365 portal';
    var t = document.querySelector('.nav-signin .nav-signin__t');
    if (t) t.textContent = label;
    var a2 = document.querySelector('.nav-signin');
    if (a2) a2.setAttribute('aria-label', aria);
    var m = document.querySelector('.mobile-menu .m-signin');
...
FOOTER = '''  <footer class="site-footer">
    ...
    <div class="site-footer__grid">
      ...
      <nav aria-label="Services links">
        ...
        <a href="/printer-support/">Printer Support</a>
        <a href="/backup-support/">Backup Support</a>
        <p class="site-footer__subhead mono">Hardware &amp; setup</p>
        ...
        <a href="/wifi-for-a-shepherds-hut/">Wi-Fi for a Shepherd&rsquo;s Hut</a>
        <a href="/starlink-internet/">Starlink Internet</a>
        <p class="site-footer__subhead mono">Web, AI &amp; robotics</p>
        <a href="/ai/">AI &amp; Automation</a>
        <a href="/web-design-hosting/">Website Design &amp; Hosting</a>
        ...
        <p class="site-footer__subhead mono">IT support by industry</p>
...
<head>
  ...
  <script>
    ...
    (function () {{
      ...
      // readers who never click, touch/scroll cover mobile. Lab runs (Lighthouse,
      // PSI) never interact, so gtag stays out of TBT/TTI entirely. The 30s
      // fallback outlives any lab trace window (a 9s timer landed INSIDE PSI's
      // observation window and dragged TTI out — TBT 2.5s. Never shorten it).
      ['pointerdown', 'keydown', 'touchstart', 'scroll', 'mousemove', 'wheel'].forEach(function (evt) {{
...
{schema_json}
  ...
  <script>
    /* Motion gate: GSAP + ScrollTrigger are DESKTOP-ONLY. Phones, tablets and
       reduced-motion users skip the ~90KB download and all the ScrollTrigger
       layout work (the main mobile TBT cost) — reveals just render visible.
       main.js boots the animations on the motion-ready event. */
    (function () {{
      var wantMotion = window.innerWidth >= 920
        && window.matchMedia('(hover: hover)').matches
        && !window.matchMedia('(prefers-reduced-motion: reduce)').matches;
      if (!wantMotion) {{ document.documentElement.classList.add('no-motion'); return; }}
...
def hero(crumbs_html, eyebrow, h1_html, lede, cta1=("See Plans &amp; Prices", "/monthly-it-support/"),
    ...
    byline_html = '\n        <p class="page-hero__byline mono"><span class="page-hero__byline-by">By the </span><a href="/meet-the-team/">365 Techies team</a> &middot; Reviewed __LASTMOD_HUMAN__</p>' if byline else ""
...
WCHECK_TOOL = r'''    <section class="section" aria-label="Free website checker" id="wctool">
        ...
        <div id="wcheck" data-reveal>
          ...
          <div class="wc-results" id="wc-results" hidden>
            ...
            <div class="wc-actions" id="wc-actions">
              ...
              <!-- Only ever revealed for a signed-in CUSTOMER (see wcSaveInit).
                   Anonymous visitors and staff/view-as sessions never see it. -->
              <button type="button" class="button wc-ghost" id="wc-save" hidden>Save to my portal</button>
            </div>
            <p class="wc-savemsg" id="wc-savemsg" hidden></p>
      ...
      /* MANDATORY, not tidiness: .button sets display:inline-flex in the author
         origin, which BEATS the user-agent [hidden]{display:none} rule - so the
         hidden attribute on #wc-save is a no-op without this, and every
         anonymous visitor is shown a Save button that cannot work. Same trap
         and same fix as #spc .spc-actions[hidden] in build_extra.py. */
      #wcheck #wc-save[hidden]{display:none}
      #wcheck .wc-savemsg{text-align:center;font-size:.84rem;line-height:1.55;margin:.2rem auto .6rem;max-width:52ch;color:var(--green,#00ce1b)}
      #wcheck .wc-savemsg.is-bad{color:#f0b34e}
      ...
      (function(){
        ...
        function render(d,u){
          ...
          /* --- keep this result (signed-in customers only) ----------------
             Stash exactly what the portal will show - scores, vitals, the top
             issues - and nothing else. Posting the whole Lighthouse payload
             would put megabytes of JSON into the shared customer database for
             no gain; the endpoint whitelists these fields anyway. */
          lastCheck={ url:host, strat:strat,
                      s:{ p:S.performance, s:S.seo, a:S.accessibility, b:S.bp },
                      cwv:cw.slice(0,4).map(function(m){ return {l:m.l, v:m.v, c:m.c}; }),
                      iss:iss.slice(0,5).map(function(it){ return it.t; }) };
          wcSaveInit();

          try{ elRes.scrollIntoView({behavior:'smooth',block:'start'}); }catch(e){}
          startCompare(S,tu);
        }
        var lastReport='', lastCheck=null;

        /* Saving a check to the portal.
           The sign-in test mirrors the site header exactly (localStorage p365 =
           customer, sessionStorage p365s = staff/view-as): a staff member
           looking at the site must NOT be offered a save, because a view-as
           session would write the result onto the customer they are viewing.
           The device id is READ, never created - the portal minted it when the
           session was minted, and inventing a fresh one here would fail the
           server's machine binding and read to the customer as "expired". */
        function wcCust(){
          try{
            var a=JSON.parse(localStorage.getItem('p365')||'{}')||{};
            var b=JSON.parse(sessionStorage.getItem('p365s')||'{}')||{};
            if(a.staff||a.stoken||b.staff||b.stoken) return null;
            if(!a.wtoken) return null;
            var m=''; try{ m=localStorage.getItem('p365mid')||''; }catch(e){}
            return { wtoken:a.wtoken, machine:m };
          }catch(e){ return null; }
        }
        function wcSaveMsg(t,bad){
          var p=root.querySelector('#wc-savemsg'); if(!p) return;
          p.textContent=t; p.hidden=!t; p.className='wc-savemsg'+(bad?' is-bad':'');
        }
        function wcSaveInit(){
          var b=root.querySelector('#wc-save'); if(!b) return;
          var who=wcCust();
          b.hidden=!who;                      // anonymous or staff: no button at all
          wcSaveMsg('');
          if(!who) return;
          b.disabled=false; b.textContent='Save to my portal';
        }
        var saveBtn=root.querySelector('#wc-save');
        if(saveBtn) saveBtn.addEventListener('click',function(){
          var who=wcCust();
          if(!who||!lastCheck){ wcSaveMsg('Sign in to your portal first.',true); return; }
          saveBtn.disabled=true; saveBtn.textContent='Saving…';
          fetch('/api/pcm-wcheck.php',{ method:'POST', headers:{'Content-Type':'application/json'},
              body:JSON.stringify({ action:'save', wtoken:who.wtoken, machine:who.machine, check:lastCheck }) })
            .then(function(r){ return r.json(); })
            .then(function(d){
              if(d&&d.ok){
                saveBtn.textContent='✓ Saved to your portal';
                wcSaveMsg('Saved — it is on your portal dashboard, with the date, so you can see how this site changes over time.');
                try{ if(window.gtag) gtag('event','website_check_saved'); }catch(e){}
              } else if(d&&d.error==='expired'){
                /* restore the label/disabled state as well as hiding: if a later
                   check re-reveals the button it must not still read "Saving…"
                   and be dead to the touch */
                saveBtn.hidden=true; saveBtn.disabled=false; saveBtn.textContent='Save to my portal';
                wcSaveMsg('Your portal session has expired — sign in again and re-run the check to save it.',true);
              } else if(d&&d.error==='slow_down'){
                saveBtn.disabled=false; saveBtn.textContent='Save to my portal';
                wcSaveMsg('Just a moment between saves, then try again.',true);
              } else {
                saveBtn.disabled=false; saveBtn.textContent='Save to my portal';
                wcSaveMsg('Couldn’t save that just now. Your result is still on screen — try again in a moment.',true);
              }
            })
            .catch(function(){
              saveBtn.disabled=false; saveBtn.textContent='Save to my portal';
              wcSaveMsg('Couldn’t reach the server. Your result is still on screen.',true);
            });
        });
...
EMAILSEC_TOOL = r'''    <section class="section" aria-label="Email security checker" id="esectool">
      ...
      (function(){
        ...
        function render(domain, spfTxts, dmarcTxts, dkimProbes, mxs, mtaStsTxts, tlsRptTxts, bimiTxts){
          ...
          /* SCORING, and why it is weighted like this.
             The three records that actually stop someone spoofing you - SPF,
             DKIM and an enforcing DMARC - are worth 100 between them. A domain
             that gets those right IS properly protected and should score top
             marks. MTA-STS and BIMI are small bonuses on top (capped at 100),
             NOT gatekeepers: BIMI needs a paid certificate to be much use, and
             MTA-STS can be blocked by a host's bot protection - neither is a
             failing of the domain owner, so neither should hold back an A. */
          /* --- SPF (max 25) --- */
...
PCBENCH_TOOL = r'''    <section class="section" aria-label="PC benchmark" id="benchtool">
        ...
        <div id="bm" data-reveal>
          ...
          <div class="bm-results" id="bm-results" hidden>
            ...
            <div class="bm-scale-wrap">
              <p class="bm-scale-title">Where you land <span>(indicative bands &middot; &#9670; measured by us)</span></p>
              <div class="bm-scale"><div class="bm-scale-fill" id="bm-scale-fill"></div><i class="bm-scale-me" id="bm-scale-me"><b>You</b></i>__BENCH_REF_MARKS__</div>
            ...
            <div class="bm-chart" id="bm-chart" hidden>
              <p class="bm-scale-title">Against everyone tested here <span id="bm-chart-sub"></span></p>
              <div class="bm-hist" id="bm-hist" hidden></div>
              <div class="bm-hist-axis" id="bm-hist-axis" hidden><span>0</span><span>25</span><span>50</span><span>75</span><span>100</span></div>
              <p class="bm-chart-line" id="bm-chart-line"></p>
            </div>
            <div class="bm-refs">__BENCH_REF_LIST__</div>
            <div class="bm-submit" id="bm-submit">
              <button type="button" class="button bm-ghost" id="bm-add">Add my score to the chart</button>
              <span class="bm-submit-note" id="bm-add-note">Anonymous: your score, the six sub-scores, thread count, browser, operating system and the graphics card name where your browser shares it. Nothing personal is sent or kept, and each computer counts once.</span>
            </div>
            ...
            <div class="bm-actions">
              ...
              <button type="button" class="button primary bm-share" id="bm-share">Share my score</button>
      ...
      #bm .bm-scale-ref{position:absolute;top:-7px;transform:translateX(-50%);width:0;height:0;pointer-events:none}
      #bm .bm-scale-ref::before{content:"◆";position:absolute;left:-6px;top:-4px;font-size:12px;color:#ffb400;line-height:1}
      #bm .bm-scale-ref b{position:absolute;left:-30px;top:-26px;width:60px;text-align:center;font-size:.66rem;font-weight:600;color:#ffb400;white-space:nowrap}
      #bm .bm-chart{margin-top:1.3rem}
      #bm .bm-chart[hidden]{display:none}
      #bm .bm-hist{display:flex;align-items:flex-end;gap:2px;height:96px;padding:0 2px;border-bottom:1px solid rgba(125,170,220,.25)}
      #bm .bm-hist[hidden],#bm .bm-hist-axis[hidden]{display:none}
      #bm .bm-hist i{flex:1;min-height:2px;background:rgba(108,196,245,.35);border-radius:3px 3px 0 0;position:relative}
      #bm .bm-hist i.me{background:#2ecc71}
      #bm .bm-hist i.me::after{content:"You";position:absolute;top:-18px;left:50%;transform:translateX(-50%);font-size:.66rem;font-weight:700;color:#2ecc71}
      #bm .bm-hist-axis{display:flex;justify-content:space-between;font-family:var(--font-mono,monospace);font-size:.66rem;color:var(--muted,#9fb5d3);margin-top:.25rem}
      #bm .bm-chart-line{margin:.7rem 0 0;font-size:.95rem;font-weight:600}
      #bm .bm-chart-line small{display:block;font-weight:400;font-size:.78rem;color:var(--muted,#9fb5d3);margin-top:.2rem}
      #bm .bm-refs{margin-top:.9rem;font-size:.8rem;color:var(--muted,#9fb5d3);line-height:1.6}
      #bm .bm-refs:empty{display:none}
      #bm .bm-refs b{color:#ffb400}
      #bm .bm-submit{display:flex;gap:.8rem;align-items:center;flex-wrap:wrap;margin-top:1rem;padding:.8rem 1rem;border-radius:12px;border:1px dashed rgba(125,170,220,.3)}
      #bm .bm-submit-note{flex:1;min-width:220px;font-size:.74rem;line-height:1.5;color:var(--muted,#9fb5d3)}
      #bm .bm-submit.done{border-style:solid;border-color:rgba(46,204,113,.45)}
      ...
      <script src="/js/pcbench.min.js?v=__BENCHV__" defer></script>
    </section>'''

# Machines we have actually run this benchmark on, on the 12 Sep 2026 scale. Only real runs go here: the
# scale's bands are indicative, these markers are measured. Add a line when a reference machine is run.
BENCH_REFS = [
    {"label": "365 workstation", "spec": "Threadripper PRO 5965WX, RTX 3090, 128 GB", "score": 95, "date": "12 Sep 2026"},
]
def _bench_ref_marks():
    return "".join('<i class="bm-scale-ref" style="left:%d%%" title="%s &middot; %d"><b>%d</b></i>' % (r["score"], r["label"], r["score"], r["score"]) for r in BENCH_REFS)
def _bench_ref_list():
    if not BENCH_REFS: return ""
    items = " &middot; ".join('<b>%d</b> %s (%s, %s)' % (r["score"], r["label"], r["spec"], r["date"]) for r in BENCH_REFS)
    return "&#9670; Measured by us on this scale: " + items + "."
PCBENCH_TOOL = PCBENCH_TOOL.replace("__BENCH_REF_MARKS__", _bench_ref_marks()).replace("__BENCH_REF_LIST__", _bench_ref_list()).replace("__BENCHV__", BENCHV)
...
PCBUILD_TOOL = r'''    <section class="section" aria-label="Custom PC builder" id="pcbtool">
      <div class="wrap">
        <div class="section-head">
          ...
          <p class="lede lede--center" data-reveal>Already own a gaming PC that has gone slow? Before you budget for a new one, see our <a href="/gaming-pc-tune-up/">remote gaming PC tune-up</a> &mdash; nothing wiped, price agreed first.</p>
...
M365_FAQS = [
  ("Can you set up Microsoft 365 from scratch?", "Yes, we handle everything: choosing the right licences, creating mailboxes and user accounts, and setting up your domain. Then we configure Outlook, Teams, OneDrive and SharePoint so it all works together from day one."),
  ...
  ("Which Microsoft 365 licence do we actually need?", "We&rsquo;ll advise honestly, from Microsoft 365 Personal and Family at home to Business Basic, Standard or Premium for teams. You get the features you need without paying for ones you don&rsquo;t."),
  ...
  ("We&rsquo;re locked out of the Microsoft 365 admin centre &mdash; what does it cost?", "A &pound;20 minimum charge for the investigation, paid before we start: we work out which recovery route applies, gather what Microsoft will ask for and keep the case moving. Anything beyond that is quoted first. The fix itself often sits with Microsoft, which is why we say the charge up front &mdash; see our guide to being <a href=\"/locked-out-microsoft-365-admin-account/\">locked out of Microsoft 365 admin</a>."),
  ...
  ("Do you support Microsoft 365 for Dorset businesses?", "Yes. We set up, migrate, secure and support Microsoft 365 for businesses right across Dorset, Bournemouth and Poole, from a single mailbox to a whole team. The help is friendly and in plain English."),
   ...
   f'''    <section class="section" aria-label="Overview">
      <div class="wrap split-2">
        <div class="prose" data-reveal>
          ...
          <p>We&rsquo;ve supported Microsoft Office since 1995, the dial-up days, and taught it for over ten years. That was at our own Dorset Microsoft Education Resource Centre in Bournemouth, and in local schools and colleges including Bournemouth &amp; Poole College and Bournemouth School for Girls. Our centre was an authorised Microsoft Office Specialist and Certiport testing centre &mdash; the plaques are on our <a href="/about/">about page</a>. As Microsoft partners and certified Office Specialists, we set up, migrate, secure and support Microsoft 365. From a single mailbox at home to a whole team in the cloud, it all works together and is managed for you.</p>
        </div>
        <ul class="checklist" data-stagger>
   ...
   f'''    <section class="section" aria-label="Why it matters">
      <div class="wrap split-2">
        <div class="prose" data-reveal>
          ...
          <p><strong>So we don&rsquo;t rely on a single tool.</strong> We build layers of protection that work together, and we manage and monitor them for you. Security actually stays switched on instead of lapsing the moment life gets busy. For businesses that need certified assurance, we also help you achieve <a href="/cyber-essentials/">Cyber Essentials</a>.</p>
        </div>
        <ul class="checklist" data-stagger>
   ...
   f'''    <section class="section" aria-label="Overview">
      <div class="wrap split-2">
        <div class="prose" data-reveal>
          ...
          <p>From a sluggish machine to one that won&rsquo;t boot, we diagnose the real problem and fix it. Then we tell you in plain English what went wrong and how to avoid it.</p>
   ...
   f'''    <section class="section" aria-label="Laptop repairs">
      <div class="wrap split-2">
        <div class="prose" data-reveal>
          ...
          <p><strong>No-fix-no-fee and a 12-month warranty</strong> on every laptop repair, with free local collection across Bournemouth, Poole and Dorset. If we uncover something nasty, we do <a href="/virus-removal/">virus removal</a> and <a href="/data-recovery/">data recovery</a> too.</p>
        </div>
        <ul class="checklist" data-stagger>
{checklist(["Slow laptop speed-ups &amp; SSD upgrades","Cracked or dim screen replacement","Battery &amp; charging-port repair","Keyboard &amp; trackpad fixes","Liquid-damage &amp; no-power diagnosis","Virus removal &amp; data recovery"])}
   ...
   faq_html([
     ...
     ("Do you repair both laptops and desktops?", "Yes — Windows laptops and desktop PCs, plus common upgrades like SSDs and more memory."),
     ("Can you replace a laptop screen or battery?", "Yes. Cracked or dim screens, worn-out batteries, charging ports, keyboards and trackpads are all common laptop repairs we carry out. You get a clear quote first and a 12-month warranty."),
 ...
 content="\n".join([
   ...
   f'''    <section class="section" aria-label="Who we are">
      <div class="wrap wrap--narrow prose" data-reveal>
        ...
        <p><strong>We&rsquo;re a family business, established in 1995, and today a leading local Managed Service Provider (MSP).</strong> Three decades on, the same friendly, no-nonsense approach still drives everything we do. Many of our customers have been with us for fifteen or twenty years. We proactively manage and protect our customers&rsquo; technology end to end, and we&rsquo;ve been a <strong>Dell reseller since 2001</strong> &mdash; as well as Microsoft partners and certified Microsoft Office Specialists.</p>
        <p>That experience runs deep. From <strong>1998 to 2008 we built and ran the Dorset Microsoft Education Resource Centre</strong>, our own training centre in Winton, Bournemouth, on a computer network we designed, built and ran ourselves. It helped local people and businesses get the most from their technology. Our certified teachers and staff also taught IT and Microsoft Office out in Dorset&rsquo;s classrooms: at <strong>Bournemouth &amp; Poole College</strong> (Dorset&rsquo;s largest further-education college), at <strong>Bournemouth School for Girls</strong>, and at <strong>Moyles Court School</strong> near Ringwood (closed 2026). They qualified as <strong>Microsoft Office Specialists</strong> back when the programme was still called Microsoft Office User Specialist, and as <strong>ECDL</strong>-certified with the British Computer Society. Our Winton centre wasn&rsquo;t just where we taught, either. It was an <strong>authorised Microsoft Office Specialist testing centre</strong> (2004), an <strong>IC3 authorised testing centre</strong> (2003) and a <strong>Certiport approved testing centre</strong> (2006). The plaques are in the photos below. We weren&rsquo;t only a local name, either: from <strong>1998 to 2008 we were the IT support partner for Mercedes-Benz Pentagon right across the south coast</strong>, and we upgraded the computers in their garages in 2001. Supporting so many sites is exactly why we began offering <a href="/remote-support/">remote support</a>, which we still do every day. Then from <strong>2008 to 2017 we ran a busy computer sales, service and support centre in Moordown, Winton</strong>. In <strong>2017 we moved to the Kinson Community Centre</strong>, where we still provide community IT support and run group training classes in person when it can&rsquo;t be done remotely. Local people have trusted us with their computers on the high street, at the community centre and now remotely, for decades. Some of the customers we first looked after back then are <strong>still with us today</strong>, relationships that now span more than twenty years.</p>
   ...
   f'''    <section class="section section--alt" aria-label="In the local press">
      <div class="wrap">
        ...
        <div class="prose" data-reveal style="max-width:74ch;margin:0 auto">
          <p>Back when we traded as <strong>365 Computers</strong> on the Moordown high street, a customer&rsquo;s laptop was stolen from his car in Poole, back in 2011. We&rsquo;d set his machine up with the same kind of <strong>remote-support software we still use to look after customers today</strong>. So our team could see it was being used, and the internet (IP) address it was connecting from. We passed the details to <strong>Dorset Police</strong>, who located the address and recovered the laptop.</p>
...
VAN_SIGNAL_MAP_MAP = r"""
    ...
    <section class="section" aria-label="Live measured signal map">
      <div class="wrap">
        ...
        <div class="prose" style="max-width:64ch;margin:1.6rem auto 0" data-reveal>
          ...
          <p style="font-size:.86rem;color:var(--muted,#8b949e);margin:.7rem 0 0;opacity:.85"><strong>Being straight about the numbers:</strong> SINR is an instant snapshot and it moves constantly while driving &mdash; ours swung between &minus;6 and 26&nbsp;dB on a single trip &mdash; whereas a speed test averages over the seconds it runs. So an individual point can pair a poor SINR with a good speed, or the reverse. The relationship is real, but it shows up properly when the van is <em>parked</em>, which is exactly the case that matters if you&rsquo;re choosing somewhere to work.</p>
        </div>
      </div>
    </section>
    ...
    (function(){var ENDPOINT='/api/signal-log.php',REFRESH=15000,GOOD=-80,BAD=-110;
      ...
      function start(){if(typeof L==='undefined'){return setTimeout(start,200);}
        ...
        /* Two self-hosted tile sets, no external map service: a UK-wide base at
           road/town detail (z0-10, ~the whole country) underneath, and the
           south-coast street-level extract taking over from z11. Same source
           data where they meet, so nothing is lost locally - and the map no
           longer ends at Chichester for anyone who zooms out or lives elsewhere. */
...
# Share row + embed. WHY BOTH, AND WHY THE CREDIT LINE SITS OUTSIDE THE IFRAME:
# an <iframe> is a separate document, so a site that embeds us does NOT link to
# us — Google sees a resource load, not a link, and no equity passes. The link
# is earned by the visible credit anchor in the SAME copy-paste block, which
# lands in the host page's own HTML. That anchor is the entire SEO point of the
# embed; the map is just what makes someone want to paste it. Never ship the
# iframe on its own, and never let that anchor become nofollow.
VAN_MAP_SHARE = r"""
    <style>
      .vshare{max-width:720px;margin:0 auto;text-align:center}
      .vshare__row{display:flex;flex-wrap:wrap;gap:.6rem;justify-content:center;margin:1.1rem 0 0;padding:0;list-style:none}
      .vshare__row a,.vshare__row button{display:inline-flex;align-items:center;gap:.5rem;padding:.62rem 1.05rem;border-radius:999px;border:1px solid rgba(125,170,220,.3);background:rgba(20,27,46,.55);color:#cfe0f5;font:600 .9rem/1 inherit;font-family:inherit;text-decoration:none;cursor:pointer;transition:border-color .2s,background .2s,transform .2s}
      .vshare__row a:hover,.vshare__row button:hover{border-color:rgba(108,196,245,.6);background:rgba(29,151,227,.16);transform:translateY(-1px)}
      .vshare__row a:focus-visible,.vshare__row button:focus-visible{outline:2px solid #6cc4f5;outline-offset:2px}
      .vshare__row svg{width:17px;height:17px;fill:currentColor;flex:0 0 auto}
      .vshare__said{min-height:1.35em;margin:.8rem 0 0;font-size:.86rem;color:#3fb950;font-weight:600}
    </style>
    <section class="section" aria-label="Share this map">
      <div class="wrap">
        <div class="vshare">
          <div class="section-head">
            <p class="eyebrow eyebrow--center mono" data-reveal>/ PASS IT ON</p>
            <h2 class="section-title section-title--center" data-title>Know someone who works from the road?<span class="title-underline title-underline--center"></span></h2>
          </div>
          <p class="lede lede--center" data-reveal>Every share puts a measured answer in front of someone who is still guessing which lay-by has signal.</p>
          <ul class="vshare__row" data-reveal>
            <li><button type="button" id="vshare-native" hidden><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81a3 3 0 100-6 3 3 0 00-3 3c0 .24.04.47.09.7L8.04 9.81A3 3 0 003 12a3 3 0 003 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65a2.92 2.92 0 105.92 0 2.92 2.92 0 00-3-2.92z"/></svg>Share</button></li>
            <li><a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2F365techies.co.uk%2Fvan-signal-map%2F" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.69.24 2.69.24v2.96h-1.52c-1.49 0-1.96.93-1.96 1.89v2.26h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07z"/></svg>Facebook</a></li>
            <li><a href="https://wa.me/?text=Where%20you%20can%20actually%20work%20from%20a%20campervan%20%E2%80%94%20real%204G%2F5G%20speed%20tests%3A%20https%3A%2F%2F365techies.co.uk%2Fvan-signal-map%2F" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.52 3.49A11.53 11.53 0 0012.05 0C5.6 0 .35 5.24.34 11.69c0 2.06.54 4.07 1.56 5.85L.24 24l6.6-1.73a11.71 11.71 0 005.2 1.32h.01c6.45 0 11.7-5.24 11.7-11.69a11.6 11.6 0 00-3.23-8.41zm-8.47 18.21h-.01a9.6 9.6 0 01-4.9-1.34l-.35-.21-3.64.96.97-3.55-.23-.36a9.62 9.62 0 01-1.47-5.13c0-5.31 4.33-9.63 9.65-9.63a9.58 9.58 0 016.81 2.83 9.53 9.53 0 012.82 6.81c0 5.31-4.33 9.62-9.65 9.62zm5.42-7.32c-.3-.15-1.76-.87-2.03-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.64.07-.3-.15-1.25-.46-2.38-1.47-.88-.79-1.47-1.76-1.64-2.05-.17-.3-.02-.46.13-.6.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.07-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.79.37-.27.3-1.04 1.02-1.04 2.48 0 1.46 1.06 2.87 1.21 3.07.15.2 2.09 3.2 5.07 4.49.71.3 1.26.49 1.69.63.71.22 1.36.19 1.87.12.57-.09 1.76-.72 2.01-1.41.25-.7.25-1.29.17-1.42-.07-.12-.27-.2-.57-.35z"/></svg>WhatsApp</a></li>
            <li><a href="https://twitter.com/intent/tweet?url=https%3A%2F%2F365techies.co.uk%2Fvan-signal-map%2F&amp;text=Where%20you%20can%20actually%20work%20from%20a%20campervan%20%E2%80%94%20real%204G%2F5G%20speed%20tests%2C%20measured%20not%20modelled" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18.9 1.15h3.68l-8.04 9.19L24 22.85h-7.41l-5.8-7.58-6.64 7.58H.47l8.6-9.83L0 1.15h7.6l5.24 6.93 6.06-6.93zm-1.29 19.5h2.04L6.49 3.24H4.3l13.31 17.41z"/></svg>X</a></li>
            <li><a href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2F365techies.co.uk%2Fvan-signal-map%2F" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.45 20.45h-3.56v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.63-1.85 3.36-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.13 2.06 2.06 0 010 4.13zM7.12 20.45H3.55V9h3.57v11.45zM22.22 0H1.77C.79 0 0 .77 0 1.72v20.56C0 23.23.79 24 1.77 24h20.45c.98 0 1.78-.77 1.78-1.72V1.72C24 .77 23.2 0 22.22 0z"/></svg>LinkedIn</a></li>
            <li><button type="button" id="vshare-copy"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.9 12a5 5 0 015-5h3v1.9h-3a3.1 3.1 0 000 6.2h3V17h-3a5 5 0 01-5-5zm5.1-1h6v2H9v-2zm4-4h3a5 5 0 010 10h-3v-1.9h3a3.1 3.1 0 000-6.2h-3V7z"/></svg>Copy link</button></li>
          </ul>
          <p class="vshare__said" id="vshare-said" role="status" aria-live="polite"></p>
        </div>
      </div>
    </section>
    <script>
    document.addEventListener('DOMContentLoaded',function(){
      var URL_='https://365techies.co.uk/van-signal-map/';
      var TXT='Where you can actually work from a campervan — real 4G/5G speed tests, measured not modelled.';
      var said=document.getElementById('vshare-said');
      function say(m){if(!said)return;said.textContent=m;setTimeout(function(){if(said.textContent===m)said.textContent='';},2800);}
      function fallback(t,m){var a=document.createElement('textarea');a.value=t;a.setAttribute('readonly','');
        a.style.position='fixed';a.style.left='-9999px';document.body.appendChild(a);a.select();
        try{document.execCommand('copy');say(m);}catch(e){say('Press Ctrl+C to copy');}document.body.removeChild(a);}
      function copy(t,m){if(navigator.clipboard&&navigator.clipboard.writeText){
          navigator.clipboard.writeText(t).then(function(){say(m);},function(){fallback(t,m);});}else{fallback(t,m);}}
      var nat=document.getElementById('vshare-native');
      if(nat&&navigator.share){nat.hidden=false;
        nat.addEventListener('click',function(){navigator.share({title:'Campervan signal map',text:TXT,url:URL_})['catch'](function(){});});}
      var cl=document.getElementById('vshare-copy');
      if(cl)cl.addEventListener('click',function(){copy(URL_,'Link copied.');});
      var ce=document.getElementById('vembed-copy'),ct=document.getElementById('vembed-code');
      if(ce&&ct)ce.addEventListener('click',function(){copy(ct.value,'Embed code copied — paste it into your page.');});
    });
    </script>
"""
...
VAN_MAP_EMBED = r"""
    <style>
      .vembed{max-width:760px;margin:0 auto}
      .vembed__code{display:block;width:100%;min-height:132px;resize:vertical;background:#0b1020;color:#cfe0f5;border:1px solid rgba(125,170,220,.28);border-radius:12px;padding:.9rem 1rem;font:.8rem/1.65 'IBM Plex Mono',ui-monospace,monospace;white-space:pre;overflow:auto}
      .vembed__code:focus{outline:2px solid #6cc4f5;outline-offset:2px}
      .vembed__btns{display:flex;gap:.7rem;justify-content:center;flex-wrap:wrap;margin:1rem 0 0}
      .vembed__why{max-width:62ch;margin:1.5rem auto 0;font-size:.87rem;color:var(--muted,#8b949e);line-height:1.65;text-align:center}
    </style>
    <section class="section" aria-label="Embed this map on your own site">
      <div class="wrap">
        <div class="vembed">
          <div class="section-head">
            <p class="eyebrow eyebrow--center mono" data-reveal>/ PUT IT ON YOUR SITE</p>
            <h2 class="section-title section-title--center" data-title>Embed the live map, free<span class="title-underline title-underline--center"></span></h2>
          </div>
          <p class="lede lede--center" data-reveal>Campsite, forum, blog or news site &mdash; paste this and you get the live map, updating as our van keeps measuring. No sign-up, no key, no tracking of your readers.</p>
          <textarea class="vembed__code" id="vembed-code" readonly rows="6" spellcheck="false" aria-label="Embed code to copy">&lt;iframe src="https://365techies.co.uk/van-signal-map/embed/"
        width="100%" height="520" loading="lazy" style="border:0;border-radius:12px"
        title="Measured 4G/5G signal map - 365 Techies campervan"&gt;&lt;/iframe&gt;
&lt;p style="font:14px/1.5 system-ui,sans-serif"&gt;Map: &lt;a href="https://365techies.co.uk/van-signal-map/"&gt;365 Techies campervan signal measurements&lt;/a&gt; (CC BY 4.0)&lt;/p&gt;</textarea>
          <div class="vembed__btns">
            <button type="button" class="button primary" id="vembed-copy">Copy the embed code</button>
            <a class="button secondary" href="/van-signal-map/embed/" target="_blank" rel="noopener">Preview it</a>
          </div>
          <p class="vembed__why" data-reveal>Please keep the credit line underneath the map &mdash; that&rsquo;s the whole licence. It tells your readers where the numbers came from and lets them check our method for themselves.</p>
        </div>
      </div>
    </section>
"""
...
# Live "van right now" panel — a curated status snapshot pushed out of the van's
# Home Assistant to api/van-live.php every 30 s (SOC, solar, signal, internet,
# town). NOT an embed of HA (that's private/tailnet-only); we publish only the
# handful of values we choose, read-only, no control surface. Location is shown
# TOWN-LEVEL only. Greys itself out when the feed goes stale (van off / HA down).
VAN_LIVE_PANEL = r"""
    <style>
      .vlive{max-width:980px;margin:0 auto}
      .vlive-bar{display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;margin:0 2px 16px;font-size:.82rem}
      .vlive-live{display:inline-flex;align-items:center;gap:8px;color:#cfe0f5;font-weight:600;letter-spacing:.03em;text-transform:uppercase}
      .vlive-dot{width:9px;height:9px;border-radius:50%;background:#3fb950;box-shadow:0 0 0 0 rgba(63,185,80,.7);animation:vlpulse 2.2s infinite}
      @keyframes vlpulse{70%{box-shadow:0 0 0 8px rgba(63,185,80,0)}100%{box-shadow:0 0 0 0 rgba(63,185,80,0)}}
      .vlive-updated{color:#8b949e;font-variant-numeric:tabular-nums}
      ...
      .vlive-meter{margin:.65rem 0 .15rem;height:7px;border-radius:5px;background:rgba(125,170,220,.16);overflow:hidden}
      .vlive-meter i{display:block;height:100%;width:0;border-radius:5px;background:#3fb950;transition:width .6s ease,background .6s ease}
      .vlive[data-state=stale]{opacity:.5;filter:grayscale(.65)}
      .vlive[data-state=stale] .vlive-dot{background:#6e7681;animation:none}
      .vlive[data-state=loading] .vlive-updated{opacity:0}
    </style>
    <section class="section" aria-label="The van right now">
      <div class="wrap">
        <div class="section-head">
          <p class="eyebrow eyebrow--center mono" data-reveal>/ LIVE TELEMETRY</p>
          <h2 class="section-title section-title--center" data-title>The van, right now<span class="title-underline title-underline--center"></span></h2>
        </div>
        <div class="vlive" id="vlive" data-state="loading">
          <div class="vlive-bar">
            <span class="vlive-live"><span class="vlive-dot"></span><span id="vlive-state">connecting&hellip;</span></span>
            <span class="vlive-updated" id="vlive-updated"></span>
          </div>
          <div class="vlive-grid">
            <div class="vlive-tile">
              <p class="vlive-k">Leisure battery</p>
              <p class="vlive-v"><span id="vl-soc">&mdash;</span><span class="vlive-u">%</span></p>
              <div class="vlive-meter"><i id="vl-soc-bar"></i></div>
              <p class="vlive-sub" id="vl-batt">&mdash;</p>
            </div>
            <div class="vlive-tile">
              <p class="vlive-k">Solar now</p>
              <p class="vlive-v"><span id="vl-solar">&mdash;</span><span class="vlive-u">W</span></p>
              <p class="vlive-sub"><span id="vl-solar-kwh">&mdash;</span> kWh today</p>
            </div>
            <div class="vlive-tile">
              <p class="vlive-k">Time to go</p>
              <p class="vlive-v vlive-v--sm" id="vl-ttg">&mdash;</p>
              <p class="vlive-sub">at this draw</p>
            </div>
            <div class="vlive-tile">
              <p class="vlive-k">Mobile signal</p>
              <p class="vlive-v"><span id="vl-rsrp">&mdash;</span><span class="vlive-u">dBm</span></p>
              <p class="vlive-sub"><span id="vl-net">&mdash;</span> &middot; <span id="vl-band">&mdash;</span></p>
            </div>
            <div class="vlive-tile">
              <p class="vlive-k">Internet</p>
              <p class="vlive-v"><span id="vl-dl">&mdash;</span><span class="vlive-u">Mbps</span></p>
              <p class="vlive-sub"><span id="vl-status">&mdash;</span> &middot; <span id="vl-latency">&mdash;</span> ms</p>
            </div>
            <div class="vlive-tile">
              <p class="vlive-k">Near</p>
              <p class="vlive-v vlive-v--sm" id="vl-town">&mdash;</p>
              <p class="vlive-sub">town level only</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
    (function(){var EP='/api/van-live.php',REFRESH=30000;
      function el(id){return document.getElementById(id);}
      function set(id,v){var e=el(id);if(e)e.textContent=(v===null||v===undefined||v==='')?'—':v;}
      function ago(s){s=Math.max(0,s|0);if(s<60)return s+'s ago';var m=(s/60)|0;if(m<60)return m+'m ago';return ((m/60)|0)+'h ago';}
      function socCol(v){if(v==null)return '#6e7681';return v>=60?'#3fb950':(v>=30?'#d29922':'#f85149');}
      function refresh(){fetch(EP+'?_='+Date.now(),{cache:'no-store'}).then(function(r){return r.json();}).then(function(j){
        var box=el('vlive');
        if(!j||j.live===false||j.t==null){box.setAttribute('data-state','stale');set('vlive-state','van offline');el('vlive-updated').textContent='';return;}
        box.setAttribute('data-state','live');set('vlive-state','live');el('vlive-updated').textContent='updated '+ago(j.age_s);
        var soc=j.soc;set('vl-soc',soc==null?'—':Math.round(soc));
        var bar=el('vl-soc-bar');if(bar){bar.style.width=(soc==null?0:Math.max(0,Math.min(100,soc)))+'%';bar.style.background=socCol(soc);}
        var bw=j.batt_w;set('vl-batt',bw==null?'—':(bw>1?('charging '+Math.round(bw)+' W'):(bw<-1?('using '+Math.round(-bw)+' W'):'idle')));
        set('vl-solar',j.solar_w==null?'—':Math.round(j.solar_w));set('vl-solar-kwh',j.solar_kwh==null?'—':j.solar_kwh);
        set('vl-ttg',j.ttg);set('vl-rsrp',j.rsrp);set('vl-net',j.net);set('vl-band',j.band);
        set('vl-dl',j.dl);set('vl-status',j.net_status);set('vl-latency',j.latency==null?'—':Math.round(j.latency));
        set('vl-town',j.town||'hidden');
      }).catch(function(){var box=el('vlive');if(box){box.setAttribute('data-state','stale');set('vlive-state','offline');}});}
      function start(){refresh();setInterval(refresh,REFRESH);}
      if(document.readyState!=='loading')start();else document.addEventListener('DOMContentLoaded',start);
    })();
    </script>
"""
...
# comes from the van's Home Assistant via api/signal-log.php (van-only, no user
# submissions -> stays out of GDPR sharing territory). Self-hosted Leaflet, free
...
add(
 ...
 content="\n".join([
   ...
   VAN_MAP_SHARE,         # straight after the ranked spots - peak "worth sharing"
   VAN_MAP_METHOD,
   VAN_MAP_REUSE,
   VAN_MAP_EMBED,         # the credit anchor in this snippet is the actual link
   VAN_SIGNAL_MAP_CARDS,
 ]),
)


def write_embed_page():
    """Write /van-signal-map/embed/ — the frameable map, and nothing else.

    Built by EXTRACTING from VAN_SIGNAL_MAP_MAP rather than restating it, so the
    embedded map can never drift from the real one. Anyone who embeds us is
    showing our work on their site; a stale copy would be worse than none.

    noindex,follow: it is the same map as the parent page, so it must not
    compete with it in search — but the links inside it should still be crawled.
    """
    src = VAN_SIGNAL_MAP_MAP
    style = re.search(r'<style>.*?</style>', src, re.S).group(0)
    body  = re.search(r'<div class="sigmap-wrap">.*?<p class="sigmap-empty".*?</p>', src, re.S).group(0)
    js    = src[src.index('<script src="/vendor/leaflet/leaflet.js"'):]
...
%s
    ...
    d = os.path.join(BASE, "van-signal-map", "embed")
