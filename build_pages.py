...
add(
 ...
 content="\n".join([
   hero(bc("Microsoft 365"), "// MICROSOFT PARTNER",
        ...
        hero_trust("We&rsquo;ve supported Microsoft Office since 1995 &mdash; the dial-up days &mdash; and taught it for over ten years &mdash; at our own Dorset Microsoft Education Resource Centre in Bournemouth, and in local schools and colleges including Bournemouth &amp; Poole College and Bournemouth School for Girls. As Microsoft partners and certified Office Specialists, we set up, migrate, secure and support Microsoft 365: from a single mailbox at home to a whole team in the cloud, all working together and managed for you."),
