...
PCM_BAND = '''    <section class="section section--alt" aria-label="365 PC Manager on your plan">
      <div class="wrap split-2">
        <div class="prose" data-reveal>
          ...
          <p>On a plan, every six-weekly service ends with a written <a href="/your-first-6-weekly-service/">Service Report</a> &mdash; what we did, how the machine scored, and anything worth planning &mdash; emailed to you, saved in your portal and left on your Desktop. And we keep an eye on the machines we look after between visits, so problems get caught before they bite. We can&rsquo;t find another IT support company in Dorset that gives its customers an app of its own.</p>
...
add(
 ...
 schema=lambda s: graph([
   ...
   faqpage(s, [
     ...
     ("How much does monthly IT support cost?", "Home support is £18.25/month per computer, and business support starts from £24.38/month per computer. Microsoft 365 can be added for £4.85/month per user. Every plan includes a full computer service every six weeks, finished with a <a href=\"/free-pc-health-check/#six-weekly-service\">written Service Report</a> &mdash; emailed to you, saved in your portal and left on your Desktop &mdash; covering what we did, how the computer scored, and anything worth planning."),
...
{steps([("Pick your plan","Choose a home or business plan. Monthly rolling, no contracts, cancel anytime."),("We call, then connect","We phone to check you&rsquo;re ready, then connect securely via Splashtop SOS &mdash; you watch everything on screen."),("Covered every month","Maintenance, protection and a friendly techie on hand, every single month.")])}
   ...
   faq_html([
     ("What is monthly IT support?", "Monthly IT support is a subscription that gives you ongoing help, regular maintenance, security checks and priority response for one predictable monthly cost — instead of paying per repair when something breaks."),
     ("How much does it cost?", "Home support is &pound;18.25/month per computer, and business support starts from &pound;24.38/month per computer. Microsoft 365 can be added for &pound;4.85/month per user. Every plan includes a full computer service every six weeks, finished with a <a href=\"/free-pc-health-check/#six-weekly-service\">written Service Report</a> &mdash; emailed to you, saved in your portal and left on your Desktop &mdash; covering what we did, how the computer scored, and anything worth planning."),
     ("Can I cancel my plan?", "Yes — plans are monthly and cancel-anytime with no lock-in contract."),
...
{steps([("Tell us what&rsquo;s wrong","Call or message and describe the problem in plain English."),("We phone first","We call to say we&rsquo;re ready and check it&rsquo;s a good time &mdash; a session only ever starts when you&rsquo;re expecting it."),("Connect securely","Click our secure link to start an encrypted Splashtop SOS session."),("Watch it get fixed","We solve it on your screen, explain what happened, and access ends.")])}
   ...
   faq_html([
     ...
     ("How much does a remote fix cost?", "Remote fix jobs are priced on difficulty and the time they take, <strong>starting from &pound;20</strong> &mdash; and a senior techie connects first to confirm what&rsquo;s needed and agree the price with you before any chargeable work. Every pay-as-you-go job also includes <strong>30 days&rsquo; follow-up remote support</strong> and a <strong>health check at 30 days</strong>. As an example, a full Windows clean install with all your data backed up and restored (about 4 hours) is <strong>&pound;149</strong>. On a <a href=\"/monthly-it-support/\">monthly plan</a> your computer is kept maintained and running, with priority support included and any fault work <strong>discounted</strong> &mdash; our customer loyalty promise."),
 ...
 content="\n".join([
   ...
   f'''    <section class="section" aria-label="Who we are">
      <div class="wrap wrap--narrow prose" data-reveal>
        ...
        <p>That experience runs deep. From <strong>1998 to 2008 we built and ran the Dorset Microsoft Education Resource Centre</strong> &mdash; our own training centre in Winton, Bournemouth, on a computer network we designed, built and ran ourselves &mdash; helping local people and businesses get the most from their technology. Our certified teachers and staff also taught IT and Microsoft Office out in Dorset&rsquo;s classrooms &mdash; at <strong>Bournemouth &amp; Poole College</strong> (Dorset&rsquo;s largest further-education college), at <strong>Bournemouth School for Girls</strong>, and at <strong>Moyles Court School</strong> near Ringwood (closed 2026) &mdash; qualified as <strong>Microsoft Office Specialists</strong> back when the programme was still called Microsoft Office User Specialist, and <strong>ECDL</strong>-certified with the British Computer Society. Our Winton centre wasn&rsquo;t just where we taught, either &mdash; it was an <strong>authorised Microsoft Office Specialist testing centre</strong> (2004), an <strong>IC3 authorised testing centre</strong> (2003) and a <strong>Certiport approved testing centre</strong> (2006). The plaques are in the photos below. We weren&rsquo;t only a local name, either: from <strong>1998 to 2008 we were the IT support partner for Mercedes-Benz Pentagon right across the south coast</strong> &mdash; we upgraded the computers in their garages in 2001, and supporting so many sites is exactly why we began offering <a href="/remote-support/">remote support</a>, which we still do every day. Then from <strong>2008 to 2017 we ran a busy computer sales, service and support centre in Moordown, Winton</strong>. In <strong>2017 we moved to the Kinson Community Centre</strong>, where we still provide community IT support and run group training classes in person when it can&rsquo;t be done remotely &mdash; so local people have trusted us with their computers, on the high street, at the community centre and now remotely, for decades. Some of the customers we first looked after back then are <strong>still with us today</strong>, relationships that now span more than twenty years.</p>
