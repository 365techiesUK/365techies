...
<head>
  ...
  <script>
    ...
    (function () {{
      ...
      // Fallback is a flat post-load timer (NOT idle callback — headless/idle
      // environments fire rIC instantly, dragging gtag's long tasks into TBT).
      // Any real interaction still loads it immediately via the listeners above.
      window.addEventListener('load', function () {{ setTimeout(loadGtagLib, 9000); }});
    }})();
  </script>
  <title>{title}</title>
