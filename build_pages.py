    ...
    <section class="section" aria-label="Live measured signal map">
      <div class="wrap">
        ...
        <div class="prose" style="max-width:64ch;margin:1.6rem auto 0" data-reveal>
          ...
          <p style="font-size:.92rem;color:var(--muted,#8b949e);margin:0">Every reading here carries <strong>SINR</strong> &mdash; signal-to-interference-plus-noise ratio. Signal strength only tells you how <em>loud</em> the mast is; SINR tells you how much of that is actually <em>usable</em> rather than drowned in interference from other traffic. It&rsquo;s the number that predicts real speed, and it&rsquo;s why a spot showing four bars can crawl while a weaker-looking one flies. Our own van has measured <strong>4 bars at 2&ndash;12&nbsp;Mbps</strong> in one place and <strong>75&nbsp;Mbps</strong> in another. Click any point to see its SINR: roughly <em>20+ excellent, 13+ good, 5+ fair, below that poor</em>.</p>
        </div>
      </div>
    </section>
