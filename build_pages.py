...
{FOOTER}
  ...
  <script src="/js/forms.min.js?v=10" defer></script>
...
PCBENCH_TOOL = PCBENCH_TOOL.replace("__BENCH_REF_MARKS__", _bench_ref_marks()).replace("__BENCH_REF_LIST__", _bench_ref_list())
