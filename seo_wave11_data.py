  ...
  'sections': [
   ...
   {'eyebrow': '// WHAT WE CANNOT DO REMOTELY',
    ...
    'html': '<p>Some causes are physical, and a remote session can find them but not fix them:</p>'
            ...
            '<p>Physical work happens by arrangement, with free collection and return across Bournemouth, Poole, Christchurch and Dorset &mdash; see <a href="/computer-repairs/">computer repairs</a>. Remote is where we start because it is where most of these problems live.</p>'},
   {'eyebrow': '// AFTERWARDS',
