...
SEO_WAVE11_PAGES = [
 {'slug': 'gaming-pc-tune-up',
  ...
  'sections': [
   {'eyebrow': '// WHY IT SLOWED DOWN',
    ...
    'html': '<p>Gaming computers slow down for the same reasons ordinary ones do, only faster, because they are used harder and download more. After a year or two, many of the ones we see have several of these at once:</p><ul><li><strong>A full drive.</strong> Modern games are 80&ndash;150 GB each. A drive that is more than about 85&ndash;90% full slows the whole machine, and games often refuse to update or launch at all.</li><li><strong>Graphics drivers a year out of date</strong>, or updated and now broken. New games ship needing new drivers; old drivers mean stutter, crashes on launch, or a black screen.</li><li><strong>Things that start with Windows.</strong> Every launcher, overlay and &ldquo;helper&rdquo; ever installed &mdash; Steam, Epic, Discord, Xbox, the RGB lighting software &mdash; running before the game does.</li><li><strong>Adware and worse from &ldquo;free&rdquo; downloads.</strong> Cracked games, mods from the wrong site, and &ldquo;free V-Bucks / Robux&rdquo; tools are the commonest way a young person&rsquo;s PC ends up carrying software that eats it alive. No blame; it is how these things are designed.</li><li><strong>Heat.</strong> Dust in the fans and heatsinks means the processor and graphics card slow themselves down to survive. It shows up as a machine that is fine for five minutes and then stutters.</li><li><strong>Windows itself</strong> &mdash; updates half-applied, a version that never finished installing, power settings that throttle everything.</li></ul><p>None of that needs a wipe. It needs someone to go through it methodically, which is what a tune-up is.</p>'},
   {'eyebrow': '// WHAT WE DO',
   ...
   {'eyebrow': '// WHAT WE CANNOT DO REMOTELY',
    ...
    'html': '<p>Some causes are physical, and a remote session can find them but not fix them:</p><ul><li><strong>Dust and heat.</strong> We can see the temperatures and tell you the fans need cleaning; we cannot hold the air duster. We will show you or your son or daughter how to do it safely, or we collect it for a proper clean.</li><li><strong>A failing drive or a graphics card on its way out.</strong> The health checks tell us; the fix is a part. We quote it straight.</li><li><strong>Not enough memory.</strong> A two-year-old machine bought with 8 GB is now below what many games want. A memory upgrade is cheap and transformative, and we tell you exactly which sticks fit.</li><li><strong>Games the machine was never fast enough for.</strong> If a new release simply needs more graphics card than it has, we say so rather than tune around it. Our free <a href="/pc-benchmark/">PC speed test</a> and <a href="/graphics-card-benchmark/">graphics card benchmark</a> put a number on it.</li></ul><p>Physical work happens by arrangement, with free collection and return across Bournemouth, Poole, Christchurch and Dorset &mdash; see <a href="/computer-repairs/">computer repairs</a>. Remote is where we start because it is where most of these problems live.</p>'},
   {'eyebrow': '// AFTERWARDS',
  ...
  'faqs': [
   ...
   {'q': 'Can you do it if we are not in Dorset?', 'a': 'Yes. The tune-up is remote, so we do it anywhere in the UK. Only the physical jobs &mdash; dust, parts, memory upgrades &mdash; need the machine with us for a day or two, collected and returned free across Bournemouth, Poole, Christchurch and Dorset.'},
 ...
 {'slug': 'gaming-pc-slow-wont-load-games',
  ...
  'lede': 'It ran everything when it was new. Now it takes an age to start, games stutter or crash on the loading screen, and the one it was bought for will not open at all. Usually it is one of seven things, and they are worth checking in this order &mdash; most take five minutes and none needs a wipe.',
  ...
  'sections': [
   ...
   {'eyebrow': '// WHEN TO GET HELP',
    ...
    'html': '<p>All seven checks are safe for a parent or a teenager to do, and most of the time they find it. When they do not &mdash; or when the malware scan lit up, or the machine has the family&rsquo;s business accounts on it and nobody wants to risk a wrong click &mdash; that is what our <a href="/gaming-pc-tune-up/">remote gaming PC tune-up</a> is: we connect while you watch, go through everything above and the things behind it, repair the games that will not launch, and leave the machine fast, with nothing wiped and the price &mdash; from &pound;65 &mdash; confirmed before we start.</p>'
            '<p>If it turns out to be dust or a part, we say so straight, and the physical work is done by us, collected and returned free across Bournemouth, Poole, Christchurch and Dorset. Either way, you find out what it actually is before you spend anything.</p>'}],
  'faqs': [
