...
BOOKING_APP = r'''    <section class="section section--alt" id="book" aria-label="Online booking">
      ...
      (function () {
        ...
        var S = { svcId: 0, svcName: '', mins: 0, days: [], dayIx: 0, date: '', time: '',
                  email: '', name: '', phone: '', note: '', mk: false, shared: false };
        var busyFlag = false;
        ...
        function doBook(wtoken) {
          ...
          post({ action: 'book', wtoken: wtoken, machine: mid(), eventId: S.svcId, date: S.date, time: S.time, phone: S.phone, note: S.note })
            .then(function (r) {
              busyFlag = false;
