...
LOCAL = [
 ...
 ("it-support-dorset", "Dorset", "South Coast",
  "Remote and on-site IT support across Dorset for homes, sole traders and small businesses — monthly support plans, computer repairs, Microsoft 365 and cybersecurity.",
  "From Bournemouth and Poole to Dorchester, Weymouth and the Blackmore Vale, we support homes and small businesses right across Dorset. Fast remote help reaches you wherever you are, with on-site visits across the county.",
...
EXTRA_SERVICES = [
 ...
 dict(slug="cyber-essentials", crumb_name="Cyber Essentials Help", accent="green",
   ...
   feats=["Cyber Essentials guidance","Readiness assessment","Get systems up to standard","Firewalls &amp; secure config","Access control &amp; MFA","Patching &amp; malware protection","Help with the questionnaire","Ongoing compliance"],
   ...
   faqs=[("What is Cyber Essentials?","It&rsquo;s a UK government-backed certification showing your business has essential cyber-security controls in place &mdash; often required to win contracts."),("Can you help us get certified?","Yes &mdash; we assess your readiness, get your systems up to standard and guide you through the certification."),("How long does it take?","It varies, but with the right controls in place certification can often be achieved quite quickly &mdash; we&rsquo;ll give you a realistic timeline."),("Can you keep us compliant?","Yes &mdash; we support ongoing compliance so you can recertify each year with confidence.")],
 ...
 dict(slug="ai-training", crumb_name="AI Training & Adoption", accent="cyan",
   ...
   faqs=[("Can you train our team to use AI?","Yes &mdash; we run friendly, hands-on training on Microsoft Copilot, ChatGPT and other AI tools, tailored to your business."),("Is it safe to use AI with our data?","With the right guidance it can be &mdash; we help you understand what&rsquo;s safe to share and set sensible guardrails."),("What AI tools do you cover?","Microsoft Copilot, ChatGPT and the practical AI tools most relevant to your work."),("Do you also build AI systems?","Yes &mdash; see our <a href=\"/agentic-ai-systems/\">agentic AI systems</a> page for custom-built automation that runs your processes.")],
 ...
 dict(slug="preventative-maintenance", crumb_name="Preventative Maintenance", accent="green",
   ...
   feats=["Full service every 6 weeks","Performance tune-up &amp; clean-up","Windows &amp; software updates","Device driver updates","Antivirus &amp; security checks","Backup checked &amp; verified","Disk health &amp; error checks","Done remotely &mdash; no fuss"],
