...
LOCAL_PROOF = {
 ...
 "it-support-christchurch": (
   ...
   "<p>In 2015 we installed a point-to-point wireless link spanning the <strong>River Avon at Knapp Mill</strong> for the <strong>Environment Agency</strong>. It carries the data for the river&rsquo;s fish counter across water where a cable was not an option. <strong>We still support it today.</strong></p>"
 ...
 "it-support-dorset": (
   ...
   "<p>We were the IT support partner for <strong>Mercedes-Benz Pentagon</strong> across the south coast from 1998 to 2008. We upgraded the computers in their garages in 2001 and started remote support back then, when it was still unusual. We built and ran the <strong>Dorset Microsoft Education Resource Centre</strong> in Bournemouth over the same decade.</p>"
...
DORSET_RELATED = '''    <section class="section" aria-label="Plans, business and industry">
      <div class="wrap">
        ...
        <div class="related" data-reveal>
          <div class="related__links"><a href="/business-it-support-plans/">Business IT support plans</a><a href="/home-it-support-plans/">Home IT support plans and pricing</a><a href="/it-support-cost-guide/">IT support cost guide</a><a href="/how-much-does-it-support-cost-uk-2026/">How much should IT support cost?</a><a href="/why-monthly-it-support-beats-per-repair/">Why monthly beats paying per repair</a><a href="/it-support-by-industry/">IT support by industry</a><a href="/business-it-support-christchurch/">Business IT support, Christchurch</a><a href="/business-it-support-ferndown-industrial-estate/">Business IT support, Ferndown industrial estate</a><a href="/business-it-support-new-forest/">Business IT support, New Forest and Lymington</a><a href="/it-support-for-sole-traders/">IT support for sole traders</a><a href="/it-support-for-home-workers/">IT support for home workers</a><a href="/it-support-for-retired-users/">IT support for retired people</a><a href="/dell-it-support-dorset/">Dell support and repair, Dorset</a><a href="/it-support-uk-europe/">IT support across the UK and Europe</a></div>
        </div>
      </div>
    </section>'''
    ...
    if slug == "it-support-dorset":
      ...
      <div class="wrap split-2">
        <div class="prose" data-reveal>
          ...
          <p><strong>You&rsquo;ve found your local team.</strong> We&rsquo;re based at the Kinson Community Centre in Bournemouth and cover every Dorset town. Most problems are fixed remotely within minutes, and when hands-on help is needed we come to you anywhere in the county, always phoning ahead with an arrival time.</p>
    ...
    content = "\n".join([
      ...
      <div class="wrap split-2">
        <div class="prose" data-reveal>
          ...
          <p>{intro_para}</p>
          <p>As your local IT company, we cover it all. IT support and business IT services, computer and laptop repairs, <a href="/microsoft-365-support/">Microsoft 365</a>, cybersecurity and practical IT solutions for {town} homes and businesses.</p>
...
LOCAL = [
 ...
 ("it-support-bournemouth", "Bournemouth", "Dorset",
  ...
  "From the town centre and Boscombe to Winton, Charminster and Southbourne, we look after home users, families, sole traders and small businesses right across Bournemouth. We have plenty of experience supporting the town&rsquo;s hospitality, tourism and professional-services firms, keeping computers, email, Wi-Fi, Microsoft 365 and security working all year round.",
...
EXTRA_SERVICES = [
 ...
 guides_title="What is the phone doing? Pick the closest, and work through it step by step on that page",
   guides=[
     ("/how-to-set-up-email-on-your-phone/", "Setting up email on a phone"),
     ("/emails-on-computer-but-not-phone/", "Emails arrive on the computer but not the phone"),
     ("/outlook-not-syncing-android/", "Outlook on Android is not syncing"),
     ("/outlook-app-asking-to-sign-in-android/", "The Outlook app keeps asking me to sign in"),
     ("/outlook-app-crashing-android/", "The Outlook app keeps crashing"),
     ("/talktalk-email-not-working-android/", "TalkTalk email stopped working on Android"),
     ("/lost-or-stolen-phone-what-to-do/", "My phone is lost or stolen"),
     ("/smartphone-lessons-for-seniors/", "The text is too small, and other first lessons"),
     ("/android-phone-course-for-beginners/", "A free Android course from the start"),
     ("/mobile-signal-check/", "Is the mobile signal the problem? Test it free"),
   ],
