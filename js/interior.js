...
/* ---------------- web forms ----------------
   Form capture lives in js/forms.js ONLY (HubSpot + Slack relay + honeypot +
   full-field capture). A second handler here used to double-submit every
   lead to HubSpot — never re-add one. */
