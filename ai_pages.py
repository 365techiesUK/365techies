...
def _intake_page(bp):
    ...
    <section class="section ai-sec" aria-label="Start an AI enquiry">
      <div class="wrap wrap--narrow">
        ...
        <p class="cc-note" style="margin-top:1.2rem">Prefer a person from the start? <a href="/contact/">Contact us</a> or call <a href="tel:+441202775566">01202 775566</a> &mdash; you never have to go through a form or a bot to reach us. Not ready to talk at all? Start with the free guides in the <a href="/ai/learn/">AI learning hub</a>.</p>
      </div>
    </section>
    <script>
    (function(){
