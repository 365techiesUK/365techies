...
if (isset($_POST['stoken']) && empty($_SESSION['pcm_ok'])) {
    ...
    header('Location: ai-admin.php'); exit;
}
...
if (empty($_SESSION['pcm_ok'])) {
    ...
    echo '<h2 style="margin:0 0 1rem">365 AI pipeline</h2><input type=password name=pass placeholder=Passphrase autofocus style="width:100%;padding:.7rem;border-radius:8px;border:1px solid #2a3b63;background:#0b1226;color:#fff;box-sizing:border-box">';
