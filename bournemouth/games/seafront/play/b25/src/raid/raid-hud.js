...
export const COPY = {
  ...
  pirate: {
    ...
    // ⚠️ The titles and *Sub lines go through banner(), which sets textContent: write a real "—",
    // never "&mdash;" - an entity there is shown to the player letter for letter.
    allyMark: 'QUAY FLEET',
    allySighted: 'SAILS ON THE HORIZON',
    allySightedSub: 'ships are standing in from the west — they are not corsairs',
    ...
    allyEngagedSub: 'their guns are running out — press the corsairs while they are busy',
    allyKill: 'QUAY FLEET SINKS ONE!',
    allyDown: 'A QUAY SHIP IS GOING DOWN',
    allyDownSub: 'her crew are in the water — they are swimming clear, as everyone in this game does',
...
export const GATE_COPY = {
  ...
  allySightedSub: 'ships are standing out of Poole — they are not corsairs',
...
export class RaidHud {
  ...
  showOver(sum, seed) {
    ...
    setNext(e.next, this.levelId, saved);
    // <<< PROGRESS
