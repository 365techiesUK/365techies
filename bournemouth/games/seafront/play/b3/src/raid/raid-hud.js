...
#rd-intro .hist { font-size: 16px; line-height: 1.45; color: #b8c9d9; font-style: italic; border-top: 1px solid rgba(255,255,255,.14); padding-top: 8px; }  /* A11Y 12 -> 16 */
...
export class RaidHud {
  ...
  update(game, pose, proj, W, H, viewYaw) {
    ...
    e.intro.classList.toggle('on', game.wave === game.firstWave && game.time < T.introSec && game.tick > 0 && game.playing);
