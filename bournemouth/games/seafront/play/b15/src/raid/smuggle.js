  ...
  constructor(mount, { onStart, onAgain, onExit, onLevels }) {
    ...
    r.innerHTML = `
      ...
      <div id="sg-over" class="sg-panel">
        ...
        <div id="sg-ofoot"><button type="button" data-a="again">RUN IT AGAIN <small>Enter</small></button><button type="button" data-a="levels" class="alt">LEVELS</button><button type="button" data-a="exit" class="alt">FREE RIDE</button></div>
      </div>`;
    mount.appendChild(r);
