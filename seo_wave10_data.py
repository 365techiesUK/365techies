...
SEO_WAVE10_PAGES = [
 {'slug': 'scam-recovery',
  ...
  'sections': [
   {'eyebrow': '// THE FIRST HOUR',
    ...
    'html': '<p>If money has gone, or someone has been on your computer, do these before you do anything with us. They matter more than the clean-up.</p>'
            ...
            '<li><strong>Report it.</strong> Report Fraud (formerly Action Fraud) on <strong>0300 123 2040</strong> (in Scotland, Police Scotland on 101). Forward scam emails to <strong>report@phishing.gov.uk</strong> and scam texts to <strong>7726</strong>, free.</li></ol>'
   ...
   {'eyebrow': '// THE CLEAN-UP',
    ...
    'html': '<p>Scammers rarely leave a computer the way they found it. In a remote session &mdash; we phone you first, you watch every move on your own screen &mdash; we go through the places they hide things:</p><ul><li><strong>Remote-access programs</strong> they installed to get in, and any &ldquo;support&rdquo; tools they left behind so they could come back.</li><li><strong>Malware and browser add-ons</strong> &mdash; including the extensions that watch what you type on banking pages.</li><li><strong>Hidden changes</strong>: new user accounts, email forwarding rules that quietly copy your mail to them, weakened security settings, saved passwords they may have read.</li><li><strong>Your protection</strong> &mdash; Windows Security switched back on and up to date, updates installed, and a full scan run to confirm the machine is clean.</li><li><strong>Your accounts</strong> &mdash; new passwords where they matter, two-factor authentication switched on, and unknown sign-ins removed from your email.</li></ul><p>Most clean-ups are a single remote session. We tell you what we found in plain English, and what it means &mdash; no jargon, no lectures; this happens to sensible people every week. If the machine genuinely can&rsquo;t be worked on remotely &mdash; it won&rsquo;t start, or the scammer locked it &mdash; that is a hands-on job, and we can collect it across Bournemouth, Poole, Christchurch and Dorset.</p>'},
   {'eyebrow': '// THE REPORT',
  ...
  'faqs': [
   ...
   {'q': 'I paid the scammer in gift cards or cryptocurrency &mdash; is that covered?', 'a': 'Sadly the bank reimbursement rules cover bank transfers, not gift cards, cash or cryptocurrency, so that money is much harder to recover &mdash; report it to Report Fraud anyway, and tell your bank if a card was used to buy the vouchers. The computer still needs checking, and the report still helps if any other payment is in dispute.'}],
 ...
 {'slug': 'youve-been-hacked-email-bitcoin-scam',
  ...
  'sections': [
   ...
   {'eyebrow': '// WHEN TO WORRY',
    ...
    'html': '<p>Three cases change the advice, and it&rsquo;s worth being honest about them.</p><ul><li><strong>You paid.</strong> Ring your bank on 159 straight away if a card or transfer was involved, report to Report Fraud (which replaced Action Fraud) on 0300 123 2040, and keep the email. Cryptocurrency payments are rarely recoverable, but reporting still matters.</li><li><strong>You clicked a link or opened an attachment in it</strong>, or you had already let someone connect to your computer recently. Treat the machine as possibly compromised: change passwords from a different device, don&rsquo;t use online banking on it, and have it checked. That is our <a href="/scam-recovery/">scam recovery service</a> &mdash; a remote check, a clean-up, and a written report for your bank if it asks.</li><li><strong>Someone really does have intimate images of you</strong> &mdash; usually from a person you spoke to online, not from a mass email. That is a different crime, and there is real help: adults can contact the Revenge Porn Helpline; anyone under 18 can use Childline&rsquo;s Report Remove tool; and the police on 101 take it seriously. Don&rsquo;t pay; paying never ends it.</li></ul>'},
   {'eyebrow': '// NEXT TIME',
  ...
  'faqs': [
   ...
   {'q': 'Should I report it to the police?', 'a': 'Forward the email to report@phishing.gov.uk, which is the quickest useful thing. If you paid or lost money, report to Report Fraud (formerly Action Fraud) on 0300 123 2040 (Police Scotland 101). The email tells you not to contact the police precisely because it works less well when you do.'},
   {'q': 'I paid. What now?', 'a': 'Don&rsquo;t pay again, however the next email threatens. Ring your bank on 159 if a card or bank transfer was involved, report to Report Fraud (formerly Action Fraud), and keep everything. If you also clicked or installed anything, have the computer checked &mdash; that&rsquo;s our scam recovery service, remote, with a report for the bank.'}],
