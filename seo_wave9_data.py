  ...
  'sections': [{'eyebrow': '/01 &mdash; WHY THE NEW OUTLOOK STRUGGLES',
               ...
               {'eyebrow': '/06 &mdash; THE BIGGER QUESTION',
                ...
                'html': '<p>Once Outlook is working again, spend five minutes on this, because '
                        ...
                        'your address you sign up with Junara and pay for it, monthly or yearly, '
                        'per address, before the date in the email Virgin sends you. Miss the date '
                        'and the mailbox is suspended; 120 days later it is deleted for '
                        'good.</p><p>If you do sign up, the Outlook setup on this page carries on: '
                        'Virgin says email programs such as Outlook should not need any settings '
                        'changed after the transfer. If you would rather not pay every year, the '
                        'alternative is an address that belongs to you rather than your provider '
                        '&mdash; Gmail or Outlook.com for most people &mdash; with the Virgin '
                        'address forwarding into it while friends, the bank and the shops are moved '
                        'across at your own pace. We have written up <a '
                        'href="/move-virgin-media-email-to-gmail/">how to move Virgin email to '
                        'Gmail</a>, and we do the whole move for you for &pound;60 per email '
                        'address, agreed before we start.</p><p><strong>Watch out for fake '
                        '&lsquo;Junara&rsquo; emails.</strong> Virgin says its own emails contain '
                        'no sign-up link and never ask for payment details, so do not pay through '
                        'an emailed link or a phone call. If you are not sure, call us before you '
                        'click.</p><p style="font-size:.85rem;color:var(--muted)">Source: Virgin '
                        'Media, <a '
