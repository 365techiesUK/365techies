          ...
          <div class="hd__screen" role="tabpanel" aria-label="Overview">
            <div class="hd__row">
              <div class="hd__card hd__card--wide">
                <h3><svg class="ic ic--spin" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3" class="ic-f"/></svg> Cameras</h3>
                <div class="hd__cams" id="hdCams"></div>
                <p class="hd__sub" id="hdCamNote">All four recording. Nothing needs you.</p>
              </div>
              <div class="hd__card">
                <h3><svg class="ic ic--flash" viewBox="0 0 24 24" aria-hidden="true"><path d="M13 2 4 14h7l-1 8 9-12h-7z"/></svg> Power</h3>
              ...
              <div class="hd__card">
                <h3><svg class="ic ic--wave" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 14a8 8 0 0 1 16 0"/><path d="M7 17a5 5 0 0 1 10 0"/><circle cx="12" cy="20" r="1.4" class="ic-f"/></svg> Broadband</h3>
                <div class="hd__big"><span id="hdNet">—</span><em>Mbps</em></div>
                <p class="hd__sub" id="hdNetNote">Router up 41 days</p>
              </div>
            </div>
            <div class="hd__row">
              <div class="hd__card"><h3><svg class="ic" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16v12H4z"/><path d="M4 7l8-4 8 4"/></svg> Backups</h3>
                <div class="hd__ok" id="hdBk">&#10003;</div><p class="hd__sub" id="hdBkNote">3 PCs backed up last night</p></div>
              <div class="hd__card"><h3><svg class="ic" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 21V6l7-3 7 3v15"/><path d="M9 21v-7h6v7"/></svg> Doors</h3>
                <div class="hd__ok" id="hdDoor">&#10003;</div><p class="hd__sub" id="hdDoorNote">All closed</p></div>
              <div class="hd__card"><h3><svg class="ic ic--cool" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3v18M4.5 7.5l15 9M19.5 7.5l-15 9"/></svg> Freezer</h3>
                <div class="hd__big"><span id="hdFrz">-19</span><em>&deg;C</em></div><p class="hd__sub">Normal</p></div>
              <div class="hd__card"><h3><svg class="ic ic--blink" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="12" rx="2"/><path d="M8 21h8"/></svg> Devices</h3>
          ...
          <div class="hd__screen" role="tabpanel" aria-label="Weather and energy">
            <div class="hd__row">
              <div class="hd__card hd__card--wide hd__wx">
                <h3><svg class="ic ic--float" viewBox="0 0 24 24" aria-hidden="true"><circle cx="9" cy="9" r="3.4"/><path d="M6 18h11a3.5 3.5 0 0 0 0-7 5 5 0 0 0-9.6-1"/></svg> Weather &mdash; <span id="wxPlace">your postcode</span></h3>
              ...
              <div class="hd__card">
                <h3><svg class="ic ic--flash" viewBox="0 0 24 24" aria-hidden="true"><path d="M13 2 4 14h7l-1 8 9-12h-7z"/></svg> Today</h3>
...
.hd__dots{display:flex;gap:0;padding:0 .1rem}
.hd__dots button{width:24px;height:24px;padding:0;border:0;background:transparent;cursor:pointer;position:relative}   /* 14 Sep 2026 (a11y audit): 24 px target, the dot is drawn inside */
.hd__dots button::before{content:"";position:absolute;left:50%;top:50%;width:8px;height:8px;margin:-4px 0 0 -4px;border-radius:50%;background:#2a3b63}
.hd__dots button[aria-selected="true"]{width:36px}
.hd__dots button[aria-selected="true"]::before{width:20px;margin-left:-10px;border-radius:4px;background:var(--cyan,#1d97e3)}
...
def build():
    ...
    body = "\n".join([
        ...
        '<div class="price-table-wrap" tabindex="0" role="group" aria-label="Price table (scrolls sideways on a small screen)"><table class="price-table">',
        '<thead><tr><th scope="col"><span class="sr-only">Feature</span></th><th>Free 365 member</th><th>On 365 Home Support</th>'
