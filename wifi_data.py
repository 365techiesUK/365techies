 ...
 'sections': [
  ...
  {'eyebrow': '/02 &mdash; THE SYMPTOM MATRIX',
   ...
   'html': '<div class="cmp-wrap"><table class="cmp-table"><thead><tr><th>Symptom</th><th>Usual cause</th><th>What actually fixes it</th></tr></thead><tbody>'
           ...
           'event. Check the DHCP lease time and look for a second DHCP server. Correlate the time with what switches on. '
           'Full method: <a href="/wifi-keeps-dropping/">WiFi keeps dropping</a>.</td></tr>'
