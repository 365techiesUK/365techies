...
OFFICE_PAGES = [
 ...
 },
 {
  ...
  "faqs": [
   ...
   },
   {
    ...
    "a": 'Yes, and it&rsquo;s often the better answer. OneDrive can be configured to sync only the folders you choose, leave your Desktop and Documents alone, and sign into the right account. Many people who ask us to remove it really just want it tamed. That&rsquo;s a single remote session for us, from &pound;20 &mdash; we&rsquo;ve supported Microsoft software since 1995 and taught it for over 10 years at our own Dorset Microsoft Education Resource Centre.'
   },
   {
    "q": "Can you just do all this for me?",
 ...
 },
 {
  ...
  "crossLinksHtml": "<p>More OneDrive and Office help: <a href=\"/onedrive-problems/\">OneDrive problems &mdash; start here</a> &middot; <a href=\"/excel-spreadsheet-rescue/\">Excel spreadsheet rescue</a> &middot; <a href=\"/microsoft-365-backup-do-you-need-it/\">Does Microsoft 365 need a backup?</a> &middot; <a href=\"/microsoft-365-support/\">Microsoft 365 support</a> &middot; <a href=\"/outlook-problems/\">Outlook problems</a> &middot; <a href=\"/how-to-secure-your-microsoft-365-account/\">Secure your Microsoft 365 account</a> &middot; <a href=\"/monthly-it-support/\">Monthly IT support</a> &middot; <a href=\"/onedrive-couldnt-merge-changes/\">OneDrive couldn&rsquo;t merge the changes</a></p>",
 ...
 },
 {
  ...
  "lede": 'First, breathe: Word failing to start does not touch your documents &mdash; they are still safely on the disk. What follows is the five-rung triage ladder we actually run on customer machines, starting with the June 2026 Windows update bug that broke Word when it was opened from Sage and other programs (Microsoft fixed it in July). We&rsquo;ve supported Word since 1995 and taught it for over 10 years at our own Dorset Microsoft Education Resource Centre &mdash; so every rung tells you plainly when to keep going and when to stop and call us.',
  "chips": [
   "Remote fix from &pound;20",
  ...
  "faqs": [
   ...
   },
   {
    ...
    "a": 'No walk-in shop &mdash; we&rsquo;re remote-first, which for a software problem like this is faster and cheaper anyway. If the machine needs hands-on work we collect it free locally across Bournemouth, Poole and the surrounding Dorset area, and we can meet by appointment at Kinson Community Centre. Businesses can book an on-site visit, priced before we come.'
   },
   {
    "q": "Does the June 2026 bug affect Excel and PowerPoint too?",
    "a": 'Yes &mdash; Microsoft&rsquo;s confirmation covers Word, Excel, PowerPoint and Access when they&rsquo;re launched from third-party software. The same workaround applies: open the Office program first, then open the document from the other application, until your PC installs Microsoft&rsquo;s fix, which arrived in Windows updates from 14 July 2026.'
   }
  ],
  "schemaKind": "service",
  ...
  "howToSteps": [
   {
    ...
    "text": 'If Word only crashes when launched from another program such as Sage, it&rsquo;s probably the KB5094126 Windows bug, fixed in updates from 14 July 2026. Install the latest Windows update; until then, open Word first, then open the document from the other program.'
   },
   {
 ...
 },
 {
  ...
  "sections": [
   ...
   },
   {
    ...
    "html": "<p>If the steps above have sorted you out &mdash; brilliant, that&rsquo;s the point of this page. But it&rsquo;s worth a call if:</p><ul><li>Documents have gone missing and checking both accounts&rsquo; OneDrives hasn&rsquo;t found them &mdash; before you assume the worst, see <a href=\"/files-missing-from-onedrive/\">files missing from OneDrive</a> or let us look. Your files are almost never actually gone.</li><li>The PC is signed into a tangle of personal and work accounts and you&rsquo;re no longer sure what is saving where.</li><li>You&rsquo;ve got several machines and want the save behaviour, OneDrive setup and backups done properly in one session.</li><li>Word itself is misbehaving beyond saving &mdash; crashing or refusing to start is a different problem with its own fix ladder: <a href=\"/microsoft-word-wont-open/\">Microsoft Word won&rsquo;t open</a>.</li></ul><p>We fix this sort of thing by <a href=\"/remote-support/\">secure remote session from &pound;20</a> &mdash; we call before we connect, you watch everything we do, and most save-settings jobs are done well inside the first half hour. If a machine needs hands-on work we collect it free locally; we&rsquo;re remote-first with no walk-in shop, and meetings at Kinson Community Centre are by appointment. We&rsquo;ve supported Microsoft software since 1995 and taught it for over 10 years at our own Dorset Microsoft Education Resource Centre &mdash; we were teaching Word back when it saved to floppy disks, so a change of save location doesn&rsquo;t faze us.</p>"
   }
  ],
  "faqs": [
   {
 ...
 },
 {
  ...
  "lede": 'You click a meeting link, Teams opens&hellip; and it&rsquo;s the wrong you. No meeting, no chat history, sometimes a &ldquo;you don&rsquo;t have access&rdquo; message while a client waits. The usual cause is one email address living as two separate Microsoft accounts &mdash; and Microsoft has no single help page for it. We untangle this for Dorset businesses; here&rsquo;s the plain-English version, including the permanent cure.',
  "chips": [
   "Family-run since 1995",
   "4.9 on Google",
   "Remote fix from &pound;20"
  ...
  "faqs": [
   ...
   },
   {
    ...
    "a": 'Usually you don&rsquo;t need to. Changing the personal account&rsquo;s alias to a free outlook.com address achieves the same separation without abandoning your business email or anything attached to either account. Starting a whole new address usually creates more work than it saves.'
   }
  ],
  "schemaKind": "service",
 ...
 },
 {
  ...
  "faqs": [
   ...
   },
   {
    ...
    "a": 'No walk-in premises &mdash; we&rsquo;re remote-first, which suits this job well since it all happens in the Microsoft 365 admin centre anyway. We visit businesses across Bournemouth, Poole, Christchurch and Dorset when on-site work is needed, priced before we come, and can meet at the Kinson Community Centre by appointment. Call 01202 775566 or text 07520 615332, Mon&ndash;Fri 9&ndash;5.'
   }
  ],
  "schemaKind": "service",
