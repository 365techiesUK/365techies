...
_OFFICE_CLUSTER = [
 ("Outlook", [
   ...
   ("btinternet-email-wont-add-to-new-outlook", "BT email won&rsquo;t add", "The new Outlook and a BT Internet mailbox, step by step."),
   ("cant-send-btinternet-email-new-outlook", "BT email won&rsquo;t send", "Receives but will not send from the new Outlook."),
   ("sky-email-wont-add-to-new-outlook", "Sky email won&rsquo;t add", "Sky&rsquo;s Yahoo-run mailbox in the new Outlook."),
   ("virgin-media-email-wont-add-to-new-outlook", "Virgin Media email won&rsquo;t add", "The account that refuses, and the classic Outlook route."),
   ("plusnet-email-wont-add-to-new-outlook", "Plusnet email won&rsquo;t add", "The settings Plusnet publishes, entered by hand."),
   ("sage-50-wont-email-invoices-outlook", "Sage 50 won&rsquo;t email invoices", "The Outlook hand-off that breaks, and the Webmail alternative."),
 ]),
 ("OneDrive", [
   ...
   ("onedrive-files-disappeared", "OneDrive files disappeared", "Get them back: recycle bin, version history, the other account."),
   ("onedrive-couldnt-merge-changes", "&ldquo;Couldn&rsquo;t merge the changes&rdquo;", "Keep both copies and lose nothing."),
   ("onedrive-file-locked-by-another-user", "File locked by another user", "Who has it open, and how to free it."),
   ("two-onedrive-accounts-personal-and-work", "Two OneDrive accounts", "Personal and work in the wrong place &mdash; the three rules that sort it."),
   ("onedrive-sharepoint-teams-explained", "OneDrive, SharePoint and Teams explained", "Which one holds what, in plain English."),
 ]),
 ("Word &amp; Excel", [
