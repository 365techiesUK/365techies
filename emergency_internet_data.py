...
{'slug': 'event-wifi-dorset',
 ...
 'chips': ['No mains power needed', 'We understand the upload', 'Honest about the limits'],
 ...
 'sections': [
  ...
  {'eyebrow': '/05 &mdash; WHAT WE NEED',
   ...
   'html': REQUIREMENTS +
           ...
           'connectivity, what absolutely must work (payments, scanning, a stream), and whether the venue requires public liability cover or a risk assessment from '
           'suppliers &mdash; most larger venues do, and it is better raised early than the week before.</p>'},
