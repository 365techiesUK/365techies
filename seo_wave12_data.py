  ...
  'sections': [
   ...
   {'eyebrow': '/05 &mdash; WHAT WE DO',
    ...
    'html': '<ul><li><strong>A full image of the working laptop.</strong> A sector-level copy of the whole disk &mdash; Windows, the software, every ECU file, exactly as it is &mdash; verified to boot. Not a copy of a folder. This is the single most valuable thing you can do for the kit, and it is where we start.</li>'
            ...
            '<li><strong>A genuine Windows XP licence</strong> on any rebuilt or spare machine. No pirated media, ever. XP still activates: since Microsoft closed its telephone activation line in December 2025, the route is Microsoft&rsquo;s Product Activation Portal, where we enter the Installation ID from the XP machine and type the Confirmation ID back. We handle that.</li>'
 ...
 {'slug': 'cnc-machine-needs-windows-xp',
  ...
  'sections': [
   ...
   {'eyebrow': '/05 &mdash; WHAT WE DO',
    ...
    'html': '<ul><li><strong>A full image of the working PC</strong> &mdash; a sector-level copy of the whole disk, verified to boot. Not a copy of a folder. This comes first, before anything else is touched.</li>'
            ...
            '<li><strong>A genuine Windows XP licence</strong> on any rebuilt or spare PC. No pirated media, ever. XP still activates: since Microsoft closed its telephone activation line in December 2025, the route is Microsoft&rsquo;s Product Activation Portal, where we enter the Installation ID from the XP machine and type the Confirmation ID back. We handle that.</li>'
  ...
  'faqs': [
   ...
   {'q': 'Can Windows XP still be activated?',
    'a': 'Yes. Microsoft closed the automated telephone line on 3 December 2025, so activation now goes through its Product Activation Portal: the XP machine shows an Installation ID, we enter it on the portal from a modern computer, and the Confirmation ID it returns activates the machine. We only ever use a genuine licence, and we handle the whole exchange.'},
